...
*Summit Teller* is a very basic application composed of two services:
...
Summit Teller is deployable to any Cloud Foundry environment utilizing the service components that have been packaged with the project.
...
----
+
Maven will automatically download all of _Summit Teller_'s dependencies. This may take a few moments.
